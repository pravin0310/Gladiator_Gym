...
?>";
	...
	<body>
		<header>
			...
			<address>
       <p>GLADIATOR FITNESS</p>
        <p> P.O.Box 34033</p>
        <p> CHIPWENUPWENU ROAD</p>
        <p> OFF KAFUE ROAD MAKENI</p>
        <p>LUSAKA, ZAMBIA.</p>
        <p> Email : khalil.ah008@gmail.com</p>
				<!-- <p>Zambia</p><p>http://ecuenta.online/gladiator</p><br><p> -->
          <div id="barcodeTarget" class="barcodeTarget"></div>
    <canvas id="canvasTarget"></canvas> </span>
			</address>
			<span><img alt="" src="gladiator_logo.png" style="width: 224px;height: 100px;">
		</header>
		<article>
			<table class="meta">
...
?></span></td>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix>Kwacha</span><span><?php
echo $total;
?></span></td>
				</tr><tr>
...
?></span></td>
		...
		<aside>
			...
			<div  >
				<p>1). All members must abide our TnC / rules otherwise membership may be withdrawn. </br></br>2). The payment is not transferable and non-refundable.</br></br>3).Fee Should be submitted within 5 business days before subjected to expiration, otherwise 50 Kwacha/Day will be charged.</br></br>4).All users should dress appropriately Or as per advised.</br></br>5).Smoking is NOT permitted at the Gym site.</br></br>6). A 1000 Kwacha for breaking/scracthing glasses belonging to "Gladiator the gym" will be imposed.
			</div>
		</aside><center><br><br><a href="view_mem.php">Voxforem Fitness Management System</center>
	</body>
</html>
